...
**Scenario range:** 8.58 – 8.61, 8.72. **Test file:** `lex/test_project/tests/celery_async/test_8m_cancel_revoke.py`. **Type:** U. **Status:** ✅ Complete (Session 66 — June 1; extended Session 67 with 8.72 covering the audit-status mapping so ABORTED is recorded as `failure`, not `success`; 5 pass / 12 sub-tests / 0.11s broker-free).
