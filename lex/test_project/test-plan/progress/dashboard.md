...
|---|---|---|---|---|---|
| 1. Init — Project Bootstrap | 28 | 227 | 121 | 0 | 0 |
...
| 1ab | MCP mode alignment + embed token hygiene regressions | 1.223-1.227 | complete | 5 | 0 | 0 | scenarios 1.223–1.227; ai-verify alignment invokes switch primitives when runtime mode drifts from project .env, skips alignment for mode=all, invoke_switch_to_mode rejects unsupported modes, _read_dotenv_value unquotes dotenv values, and lex_embed_view keeps auth_token out of model-visible narration. |
