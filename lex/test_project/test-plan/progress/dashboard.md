...
| 1u. Readiness probe + ASGI HTTP routing (Session 81 — June 18) | 9 | 9 | 9 | 0 | 0 | ✅ Complete — scenarios 1.171–1.179; `is_readiness_path()`, `readiness_asgi_app()` 200/503, `_database_ready()` exception→False, `http_application()` dispatch to health/readiness/django |
