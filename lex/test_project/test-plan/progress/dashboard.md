...
|---|---|---|---|---|---|
| 1. Init — Project Bootstrap | 23 | 197 | 91 | 0 | 0 |
...
| 1i | rebase_incident_datetimes — re-anchor datetimes corrupted by the TIME_ZONE incident | 1.195-1.197 | complete | 3 | 0 | 0 | management command that surgically re-anchors user-entered datetimes mis-stored after the rc212 TIME_ZONE flip (f622c9c); dry-run by default, per-instance --cutoff window, excludes app-stamped created_at/edited_at and pre-incident rows. Ships with the USE_TZ=True cutover. |
