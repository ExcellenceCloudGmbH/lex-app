...
| 1u. lex-app version reporter — startup push of installed version to IC (Session 79) | 7 | 7 | 7 | 0 | 0 | ✅ Complete — scenarios 1.171–1.177; pins gating (not-deployed skips), once-per-process guard, `force=True` test escape, HTTP shape (URL + Api-Key header + body), and silent failure on both network errors and non-200 responses |
