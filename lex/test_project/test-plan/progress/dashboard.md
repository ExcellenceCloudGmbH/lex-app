...
| 5. History & Bitemporal | 12 | 101 | 13 | 6 | 3 |
...
| 5m | Edit-time correctness + as_of time-travel round trip | 5.98-5.101 | complete | 3 | 0 | 1 | end-to-end edited_at → Z serialization → parse_as_of_datetime → get_queryset_as_of chain; 5.101 xfail(strict) pins BUG-026 (edited_at vs valid_from/sys_from clock-read gap) |
