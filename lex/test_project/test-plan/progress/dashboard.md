...
| 1ab | MCP embed + AI setup/verify tooling contracts | 1.223-1.227 | complete | 5 | 0 | 0 | coverage batch for PR #703; pins embed URL token redaction, mode validation, verify-mode alignment, and setup project-root targeting across `lex/mcp_server/tools/embed.py`, `lex/tools/mcp_mode_invoke.py`, `lex/tools/setup_with_ai.py`, and `lex/tools/verify_ai_assets.py`. |
