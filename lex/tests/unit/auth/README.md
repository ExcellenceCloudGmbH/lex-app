...
| `test_auth_logout.py` | — | Logout flow — session cleanup, OIDC end-session |
| `test_keycloak_middleware.py` | — | Keycloak auth middleware — token extraction, claim parsing |
| `test_token_context.py` | — | TokenContext — token decoding, claim extraction, expiry checks |
...
lex test lex.tests.unit.auth               # all tests
