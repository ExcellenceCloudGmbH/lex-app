...
The implementation of this module lives in :mod:`lex_mcp.ai_dashboard`,
...
``from lex.tools.ai_dashboard import launch_ai_dashboard`` keep working.
"""
from __future__ import annotations

try:
    from lex_mcp import ai_dashboard as _impl
except ImportError as _err:  # pragma: no cover - defensive
    raise ImportError(
        "lex-mcp-local is not installed. Run `lex setup-with-ai` to install it."
    ) from _err

from lex_mcp.ai_dashboard import *  # noqa: F401,F403
