---
title: "Scheduled Calculations — DESIGN DRAFT, NOT IMPLEMENTED"
status: withdrawn
withdrawn: 2026-09-14
---

> [!danger] This describes an API that does not exist
> `ScheduledCalculation` and `lex.lex_app.scheduling` appear nowhere in the
> framework. This is a **design sketch**, and it was mistaken for finished
> documentation once already: it was published to lex-app-docs in #176 with a
> parameter table and three conflict modes, and removed in #180.
>
> It is kept because the design is worth having if the feature is ever built.
> If you move it anywhere, this banner goes with it.
